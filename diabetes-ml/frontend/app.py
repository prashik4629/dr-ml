...
try:
    ...
    API_URL = os.getenv("API_URL", "http://127.0.0.1:8001/api/v1/predict")
    API_KEY = os.getenv("API_KEY", "drml-dev-key-change-in-production")

st.set_page_config(
    page_title="Dr.ML — Diabetes",
    page_icon="🩺",
    layout="wide",
...
with st.sidebar:
    ...
    <div style='text-align:center; padding: 1rem 0 2rem;'>
        ...
        <div style='font-size:0.75rem; color:#718096; margin-top:0.25rem;'>Diabetes Prediction</div>
    </div>
    """, unsafe_allow_html=True)
...
if page == "Prediction":
    ...
    <div style='margin-bottom:2rem;'>
        ...
        <p class='hero-sub'>Enter patient vitals to receive an AI-powered diabetes risk assessment</p>
    </div>
    """, unsafe_allow_html=True)
        ...
        for i, row in df_history.iterrows():
            ...
            <div class='glass-card' style='display:flex;
                ...
                <div style='display:flex; gap:2rem; align-items:center;'>
                    ...
                    <div style='color:#e2e8f0;'>{row["age"]} yrs · BMI {row["bmi"]}</div>
...
# ══════════════════════════════════════════
    ...
    <div style='margin-bottom:2rem;'>
        ...
        <p class='hero-sub'>AI-powered diabetes risk prediction system</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with c1:
        ...
        <div class='glass-card'>
            ...
            <div style='color:#a0aec0; font-size:0.9rem; line-height:1.9;'>
                ...
                2. 4 engineered features are created automatically<br>
                3. SMOTE balances class distribution<br>
                4. Voting Ensemble runs inference<br>
                5. Risk level and probability are returned
            </div>
        </div>
        """, unsafe_allow_html=True)
